...
// ELIMINADA LA IMPORTACIÓN DE currentTheme
...
export default function ScannerView() {
  ...
  return (
    <div ref={containerRef} className="flex w-full flex-col items-center justify-center">
      <div 
        ref={scannerBoxRef}
        className="invisible flex w-full max-w-md flex-col justify-between min-h-140 rounded-2xl border border-slate-200 bg-white p-6 shadow-xl"
      >
        <div>
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-4">
          <div className={`relative w-full overflow-hidden rounded-xl border border-slate-200 bg-black shadow-inner transition-all duration-300 ${isScanning ? 'aspect-square' : 'h-48'}`}>
            {!isScanning && (
          ...
          <div className="w-full min-h-35 flex flex-col justify-center">
            {scannerError && (
            ...
            {scannedCode && (
              <div className="success-badge invisible flex items-center gap-3 rounded-xl border border-emerald-100 bg-emerald-50 p-4 text-emerald-900">
