    ...
    <main className="min-h-screen bg-slate-50 p-2 sm:p-4 pb-16">
      ...
      <div className="mb-3 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-900 text-white shadow-md shadow-slate-200">
          ...
          {isScanning ? (
            <div className="relative h-44 bg-slate-900 w-full">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white/50 pointer-events-none">
                <div className="h-28 w-28 border-2 border-dashed border-slate-900 rounded-2xl animate-pulse flex items-center justify-center bg-black/10">
              ...
              <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enterTo="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 translate-y-0 sm:scale-100" leaveTo="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                <Dialog.Panel className="relative transform overflow-hidden rounded-[2.5rem] p-10 text-center shadow-2xl w-full max-w-sm border border-slate-100 bg-white">
                  <div className="flex flex-col items-center gap-6">
                    ...
                    <div>
                      <Dialog.Title as="h3" className="text-2xl font-black tracking-tight text-slate-900">¿Nos vemos luego?</Dialog.Title>
                      <p className="mt-3 text-sm font-medium text-slate-500 leading-relaxed">Tu turno se cerrará de forma segura. <br /> ¡Buen trabajo hoy!</p>
                    </div>
                  </div>
                  <div className="mt-10 flex flex-col gap-3">
                    <button type="button" onClick={handleLogout} className="w-full rounded-2xl bg-red-600 hover:bg-red-700 py-4 text-sm font-bold text-white transition-all cursor-pointer shadow-lg shadow-red-100 active:scale-95">Sí, cerrar sesión</button>
                    <button type="button" onClick={() => setShowLogoutModal(false)} className="w-full rounded-2xl bg-slate-50 py-4 text-sm font-bold transition-all cursor-pointer text-slate-500 hover:bg-slate-100">Volver atrás</button>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
            </div>
